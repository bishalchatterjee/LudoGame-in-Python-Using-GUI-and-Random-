...
class Ludo:
    def __init__(self, root,six_side_block,five_side_block,four_side_block,three_side_block,two_side_block,one_side_block):
        self.window = root
        # Make canvas
        self.make_canvas = Canvas(self.window, bg="#FFFFFF", width=800, height=630)
    ...
    def board_set_up(self):
        ...
        self.make_canvas.create_rectangle(100, (15+240)+(40*3), 100+240, (15+240)+(40*3)+(40*6), width=3, fill="blue")# left down large square
        ...
        self.make_canvas.create_rectangle(100+240+40, (15 + 240)+(40*3), 100 + 240+40+40, (15 + 240)+(40*3)+(40*6)-40, width=3, fill="blue")
        ...
        self.make_canvas.create_rectangle(100 + 40, 340+80+15, 100 + 40 + 40, 340+80+40+15, width=3, fill="blue")
        self.make_canvas.create_rectangle(100 + 40 + 60 + 40+20, 340+80+15, 100 + 40 + 60 + 40 + 40+20, 340+80+40+15, width=3, fill="blue")
        self.make_canvas.create_rectangle(100 + 40, 340+80+60+40+15, 100 + 40 + 40, 340+80+60+40+40+15, width=3, fill="blue")
        self.make_canvas.create_rectangle(100 + 40 + 60 + 40+20, 340+80+60+40+15, 100 + 40 + 60 + 40 + 40+20, 340+80+60+40+40+15, width=3, fill="blue")
        ...
        self.make_canvas.create_rectangle(100+240,340+(40*5)-5,100+240+40,340+(40*6)-5,fill="blue",width=3)
        # Red start position
        ...
        self.make_canvas.create_polygon(100 + 240, 15 + 240+(40*3), 100 + 240 + 60, 15 + 240 + 60, 100 + 240 + (40 * 3), 15 + 240+(40*3), width=3, fill="blue",outline="black")
        ...
        sky_blue_1_coin = self.make_canvas.create_oval(100 + 40, 340+80+15, 100 + 40 + 40, 340+80+40+15, width=3, fill="blue", outline="black")
        sky_blue_2_coin = self.make_canvas.create_oval(100 + 40 + 60 + 40+20, 340+80+15, 100 + 40 + 60 + 40 + 40+20, 340+80+40+15, width=3, fill="blue", outline="black")
        sky_blue_3_coin = self.make_canvas.create_oval(100 + 40 + 60 + 40 + 20, 340 + 80 + 60 + 40 + 15, 100 + 40 + 60 + 40 + 40 + 20, 340 + 80 + 60 + 40 + 40 + 15, width=3, fill="blue", outline="black")
        sky_blue_4_coin = self.make_canvas.create_oval( 100 + 40, 340+80+60+40+15, 100 + 40 + 40, 340+80+60+40+40+15, width=3, fill="blue", outline="black")
        ...
        sky_blue_1_label = Label(self.make_canvas, text="1", font=("Arial", 15, "bold"), bg="blue", fg="black")
        sky_blue_1_label.place(x=100 + 40 + 10, y=30 + (40 * 6) + (40 * 3) + 40 + 10)
        sky_blue_2_label = Label(self.make_canvas, text="2", font=("Arial", 15, "bold"), bg="blue", fg="black")
        sky_blue_2_label.place(x=100 + 40 + 60 + 60 + 10, y=30 + (40 * 6) + (40 * 3) + 40 + 10)
        sky_blue_3_label = Label(self.make_canvas, text="3", font=("Arial", 15, "bold"), bg="blue", fg="black")
        sky_blue_3_label.place(x=100 + 40 + 60 + 60 + 10, y=30 + (40 * 6) + (40 * 3) + 40 + 60 + 40 + 10)
        sky_blue_4_label = Label(self.make_canvas, text="4", font=("Arial", 15, "bold"), bg="blue", fg="black")
    ...
    def take_initial_control(self):
        ...
        head = Label(top,text="Please Enter Number of players [Min. 2 Players/Max. 4 Players]",font=("Arial",12,"bold","italic"),bg="white",fg="black")
        ...
        def filtering():# Total player input value filtering
            ...
            if response_take is True and int(take_entry.get())>1:
                ...
                messagebox.showerror("Input Error", "Invalid entry!! Enter between 2-4.")

        submit_btn = Button(top,text="Proceed",bg="white",fg="black",font=("Arial",12,"bold","italic"),relief=RAISED,bd=8,command=filtering)
    ...
    def instruction_btn_red(self):
        ...
        predict_red = Button(self.make_canvas, bg="black", fg="yellow", relief=RAISED, bd=5, text="Roll Dice", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("red"))
        ...
        final_move = Button(self.make_canvas,bg="black",fg="red",relief=RAISED,bd=5,text="Move",font=("Arial",8,"bold"),command=lambda: self.main_controller("red",entry_take_red.get()),state=DISABLED)
        final_move.place(x=42,y=15+140)
        Label(self.make_canvas,text="Player 1",bg="white",fg="black",font=("Arial",10,"bold")).place(x=35,y=15+140+40)
    ...
    def instruction_btn_sky_blue(self):
        ...
        predict_sky_blue = Button(self.make_canvas, bg="black", fg="yellow", relief=RAISED, bd=5, text="Roll Dice",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("sky_blue"))
        ...
        final_move = Button(self.make_canvas, bg="black", fg="red", relief=RAISED, bd=5, text="Move", font=("Arial", 8, "bold"),command=lambda: self.main_controller("sky_blue",entry_take_sky_blue.get()),state=DISABLED)
        final_move.place(x=42, y=15+(40*6+40*3)+40 + 110)
        Label(self.make_canvas, text="Player 2", bg="white", fg="black", font=("Arial", 10, "bold")).place(x=35,y=15+(40*6+40*3)+40 + 110+ 40)
    ...
    def instruction_btn_yellow(self):
        ...
        predict_yellow = Button(self.make_canvas, bg="black", fg="yellow", relief=RAISED, bd=5, text="Roll Dice",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("yellow"))
        ...
        final_move = Button(self.make_canvas, bg="black", fg="red", relief=RAISED, bd=5, text="Move",font=("Arial", 8, "bold"),command=lambda: self.main_controller("yellow",entry_take_yellow.get()),state=DISABLED)
        final_move.place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 2)+17, y=15 + (40 * 6 + 40 * 3) + 40 + 110)
        Label(self.make_canvas, text="Player 3", bg="white", fg="black", font=("Arial", 10, "bold")).place(x=113 + (40 * 6 + 40 * 3 + 40 * 6 + 3),y=15 + (40 * 6 + 40 * 3) + 40 + 110 + 40)
    ...
    def instruction_btn_green(self):
        ...
        predict_green = Button(self.make_canvas, bg="black", fg="yellow", relief=RAISED, bd=5, text="Roll Dice", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("green"))
        ...
        final_move = Button(self.make_canvas, bg="black", fg="red", relief=RAISED, bd=5, text="Move",font=("Arial", 8, "bold"),command=lambda: self.main_controller("green",entry_take_green.get()),state=DISABLED)
        final_move.place(x=100+(40*6+40*3+40*6+2)+17, y=15 + 140)
        Label(self.make_canvas, text="Player 4", bg="white", fg="black", font=("Arial", 10, "bold")).place(x=113+(40*6+40*3+40*6+3), y=15 + 140+40)
    ...
    def sky_blue_circle_start_position(self,coin_number):
        ...
        self.made_sky_blue_coin[int(coin_number)-1] = self.make_canvas.create_oval(100+240,340+(40*5)-5,100+240+40,340+(40*6)-5,fill="blue",width=3)
    ...
    def main_controller(self, color_coin, coin_number):
        ...
        if processing_result is True:
            ...
            messagebox.showerror("Opps!!","Please input the coin number between 1 to 4")
            return
...
if __name__ == '__main__':
    ...
    window.title("Ludo Game [Using GUI and Random]")
